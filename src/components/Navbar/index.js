...
export default function Navbar({ toggleNav, navState, id }) {
    ...
    return (
        <nav className={boot.nav}>
                        ...
                        <Col size={'md-6'} classes={boot.col2}>
                            <div className={boot.flex}>
                                ...
                                <p className={'new-line'}>
                                    <em>{data.navTxt}
                                    <i className={font.github}></i>
                                    <a href={data.github} target="_blank" rel='noreferrer noopener'>GitHub Profile.</a> {"\n"}
                                    <i className={font.linkedin}></i>
                                    <a href={data.linkedin} target="_blank" rel='noreferrer noopener'>Linkedin Profile.</a>
                                    </em>
                                </p>
                            </div>
                        </Col>
            ...
            <Container>
                <Link to="/" className={'navbar-brand'}>Page Tyler</Link>
                <BurgerBtn toggleNav={toggleNav} navState={navState}></BurgerBtn>
            </Container>
        </nav>
    )
}
